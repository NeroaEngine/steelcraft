export const canonicalPortals = [
  { id: 'admin', canonicalKey: 'core.admin', title: 'Admin', kind: 'Customer admin controls', description: 'Users, roles, portal access, customer-facing settings, and tenant administration.', route: '/portal/admin', package: 'core', scope: 'canonical' },
  { id: 'accounting', canonicalKey: 'core.accounting', title: 'Accounting', kind: 'Accounting workflow', description: 'AR, AP, invoices, bills, payments, chart of accounts, GL, reporting, retainage, and project financials.', route: '/portal/accounting', package: 'core', scope: 'canonical' },
  { id: 'contacts', canonicalKey: 'core.contacts', title: 'Contacts / CRM', kind: 'Relationships', description: 'Companies, customer contacts, vendor contacts, contractor contacts, project contacts, and account history.', route: '/portal/contacts', package: 'core', scope: 'canonical' },
  { id: 'hr', canonicalKey: 'core.hr', title: 'HR Portal', kind: 'Human resources', description: 'Salary employee records, PTO, handbook, HR support, onboarding, and training modules. No time clock.', route: '/portal/hr', package: 'core', scope: 'canonical' },
  { id: 'vendor', canonicalKey: 'core.vendor', title: 'Vendor Portal', kind: 'Outside vendors', description: 'Assigned packages, vendor-facing PO visibility, due dates, upload slots, and packet status.', route: '/portal/vendor', package: 'core', scope: 'canonical' },
  { id: 'customer', canonicalKey: 'core.customer', title: 'Customer Portal', kind: 'Outside customers', description: 'Approved project status, documents, quotes, contracts, change orders, payments, approvals, and uploads.', route: '/portal/customer', package: 'core', scope: 'canonical' },
