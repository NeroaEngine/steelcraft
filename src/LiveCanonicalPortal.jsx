...
const canonicalLiveData = {
  ...
  contacts: { title: 'Contacts / CRM', intro: 'Master company, people, customer, vendor, contractor, project contact, account history, cleanup, and accounting handoff lane.', metrics: [['Companies', '128', 'Customer / vendor / contractor'], ['People', '342', 'Contacts and approvers'], ['Cleanup', '18', 'Duplicates and missing billing info'], ['Accounting link', 'Live', 'Feeds customers and vendors']], actions: ['New company', 'Import list', 'Clean duplicates', 'Push to Accounting'], sections: baseSections.contacts, formTitle: 'Add / import contact' },
...
const actionBlueprints = {
  ...
  contacts: { 'New company': ['Create company', 'Add primary contact', 'Classify customer/vendor', 'Link to accounting'], 'Import list': ['Upload CSV', 'Map columns', 'Preview cleanup', 'Import records'], 'Clean duplicates': ['Find duplicates', 'Merge companies', 'Fix missing emails', 'Proof cleanup'], 'Push to Accounting': ['Create customers', 'Create vendors', 'Apply terms', 'Open setup report'] },
    ...
    <section className="live-module-shell canonical-force-live">
      ...
      <div className="live-module-grid">
        ...
        <article className="live-module-card">
          ...
          <div className="live-module-proof"><strong>Proof-ready path</strong><span>Action captured to Neroa Policy to record write to Proof/Audit event.</span></div>
        </article>
      </div>
    </section>
  </>;
